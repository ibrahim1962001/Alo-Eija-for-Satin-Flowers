...
const values = [
  {
    ...
    title: "الشغف",
    description:
      "كل وردة نصنعها تحمل جزءاً من قلبنا. الشغف هو ما يميز عملنا ويجعل كل قطعة فريدة.",
  },
  {
    icon: Scissors,
    title: "الحرفية",
    description:
      "سنوات من الخبرة في فن تصنيع ورد الستان، مع اهتمام بأدق التفاصيل في كل بتلة.",
  },
  {
    icon: Palette,
    title: "الإبداع",
